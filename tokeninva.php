...
<div class="modal modalUP">
    <div class="modal__container">
        <h2 class="modal-title">Para Cancelar el Bloqueo sera necesario el uso del Token o Sms a tu telefono.</h2><br>
   <a style="color:red;font-size: 12px;">Token o Codigo no valido o expirado. Por favor ingresa un nuevo Token o Codigo.</a>
    <style>
			.token-container {
				display: flex;
